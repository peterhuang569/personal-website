    ...
    <section className = "text-white">
        <div className="md:grid md:grid-cols-2 gap-8 item-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
            ...
            <div className = "border border-2 border-white rounded-lg">    
                ...
                I am currently navigating the exciting landscape of my second year as a Computer Science student. My journey through my degree has ignited a fascination for Fullstack Development, both the front-end and back-end intricacies of web applications.
                </p>
